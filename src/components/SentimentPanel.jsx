...
// Sentiment is generated by Groq (primary) with Gemini as fallback — see
// etl/sentiment_gemini.py. Label shown next to the AI-generated content
// should reflect whichever provider actually produced it, not be hardcoded.
    ...
    <section className="max-w-6xl mx-auto px-4 py-16">
      <div className="text-center mb-10">
        ...
        <p className="text-sm text-gray-500 mt-3 max-w-lg mx-auto">
          Daily analysis generated by Groq (Gemini as fallback) from consolidated mobility, fuel, ridership, and WFH data
        </p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 leading-relaxed mt-2">
                Both Groq and Gemini API quotas were exhausted on the last pipeline run — no AI-generated
                signals for today. The MF-Index itself (<strong>{d.overall_score}/100</strong>) is still
                computed directly from live data, unaffected by this.
              </p>
